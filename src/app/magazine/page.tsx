...
export default function MagazinePage() {
  ...
  return (
    <main style={{ fontFamily: "Pretendard,-apple-system,sans-serif", background: "#fff", minHeight: "100vh" }}>
      ...
      {/* PAGE TITLE + 검색 + 필터 */}
      <div style={{ padding: "32px 40px 0", borderBottom: "0.5px solid #eee" }}>
      ...
      {/* COUNT + 선택 필터 */}
      <div style={{ padding: "14px 40px", display: "flex", justifyContent: "space-between", alignItems: "center", borderBottom: "0.5px solid #eee" }}>
          ...
          {Array.from({ length: totalPages }, (_, i) => i + 1).map((p) => (
            <button
              ...
              style={{
                ...
                background: p === page ? "#0A0A0A" : "none",
                color: p === page ? "#fff" : "#555",
                border: `0.5px solid ${p === page ? "#0A0A0A" : "#eee"}`,
                cursor: "pointer",
